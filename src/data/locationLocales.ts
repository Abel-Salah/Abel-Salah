...
export const locations: LocationContent[] = [
  ...
  {
    slug: "expert-ia-toulouse",
    path: "/expert-ia-toulouse",
    lang: "fr",
    city: "Toulouse",
    country: "FR",
    seoTitle: "Expert IA à Toulouse | Audit, Automatisation, Formation — Abel SALAH",
    seoDescription:
    ...
    kicker: "Expert IA — Toulouse",
    titlePre: "Expert IA à ",
    titleHighlight: "Toulouse",
    intro: [
      "Toulouse est ma ville de formation — j'y ai fait mes études supérieures de commerce (ESG, IGS) avant de construire mon parcours dans le digital et l'IA. J'y interviens en séquences sur site : audit, ateliers d'équipes, formation, puis un suivi à distance resserré.",
      "J'accompagne les PME, ETI et industriels de la région toulousaine dans l'intégration concrète de l'IA : automatiser les processus qui coûtent du temps, fiabiliser la prospection et le suivi commercial, former les équipes pour une adoption durable.",
    ],
    servicesTitle: "Ce que je fais sur site à Toulouse",
    services: [
      {
        title: "Audit IA",
        text: "Une immersion dans vos processus métiers et industriels : diagnostic, priorisation ROI et feuille de route 30/60/90 jours.",
        to: "/audit-ia",
        linkLabel: "Découvrir l'audit IA",
      },
      {
        title: "Automatisation commerciale",
        text: "Prospection, devis, relances, reporting : des workflows fiables construits avec vos équipes commerciales et ADV.",
        to: "/automatisation-commerciale",
        linkLabel: "Découvrir l'automatisation",
      },
      {
        title: "Formation IA",
        text: "Ateliers pratiques par métier dans vos locaux : prompting utile, cas d'usage réels, routines d'adoption.",
        to: "/formation-ia",
        linkLabel: "Découvrir la formation",
      },
    ],
    localTitle: "Un lien réel avec Toulouse",
    local: [
      "C'est à Toulouse que je me suis formé au commerce et au développement d'entreprise — un ancrage personnel qui rend les allers-retours naturels. L'écosystème est unique en France : aéronautique et spatial, sous-traitance industrielle, scale-ups B2B, IoT et santé.",
      "Ce tissu industriel et commercial est un terrain idéal pour l'IA appliquée : des processus structurés, des données existantes, et des gains mesurables dès qu'on automatise la préparation, le suivi et le reporting.",
    ],
    sectorsTitle: "Secteurs accompagnés en Occitanie",
    sectors: ["Aéronautique & supply chain", "Industrie", "SaaS & éditeurs", "Services B2B", "Formation", "Retail"],
    termsTitle: "Modalités",
    terms: [
      { label: "Présence", value: "Déplacements réguliers à Toulouse et en Occitanie, interventions de 1 à 2 jours sur site" },
      { label: "Formats", value: "Audit, ateliers en équipe, formation intra, accompagnement mensuel" },
      { label: "Langues", value: "Français, espagnol, anglais" },
      { label: "Premier rendez-vous", value: "Audit découverte gratuit de 30 minutes en visio" },
    ],
    faqTitle: "Questions fréquentes",
    faq: [
      {
        q: "Vous déplacez-vous à Toulouse pour une mission ?",
        a: "Oui — Toulouse est ma ville de formation et j'y garde des attaches. Les missions s'organisent en séquences sur site de un à deux jours (audit, ateliers, restitution), complétées par un suivi à distance efficace.",
      },
      {
        q: "Travaillez-vous avec l'industrie et la sous-traitance aéronautique ?",
        a: "Oui. Les processus industriels et commerciaux structurés — devis, planification, suivi qualité, relances — sont un terrain où l'automatisation et l'IA produisent des gains rapides et mesurables. On démarre toujours par un diagnostic de vos processus réels.",
      },
      {
        q: "Comment démarre une collaboration ?",
        a: "Par un audit découverte gratuit de 30 minutes en visio. On identifie 2-3 cas d'usage prioritaires, puis je vous propose une feuille de route avec un périmètre, un calendrier et des indicateurs de succès.",
      },
    ],
    ctaTitle: "Parlons de votre projet IA à Toulouse",
    ctaText: "Réservez un créneau : audit découverte gratuit de 30 minutes.",
    ctaButton: "Réserver un créneau",
    ctaContactLabel: "Ou passez par la page contact",
    breadcrumbHome: "Accueil",
    otherCitiesTitle: "J'interviens aussi à",
  ...
  {
    slug: "expert-ia-bordeaux",
    path: "/expert-ia-bordeaux",
    lang: "fr",
    city: "Bordeaux",
    country: "FR",
    seoTitle: "Expert IA à Bordeaux | Audit, Automatisation, Formation — Abel SALAH",
    seoDescription:
    ...
    kicker: "Expert IA — Bordeaux",
    titlePre: "Expert IA à ",
    titleHighlight: "Bordeaux",
    intro: [
      "J'interviens à Bordeaux et en Nouvelle-Aquitaine en séquences denses sur site : audit de vos processus, ateliers avec les équipes, formation — puis un suivi à distance qui maintient le rythme entre deux déplacements.",
      "Mon terrain de jeu : les PME et ETI dont les processus commerciaux et administratifs coûtent du temps chaque semaine — négoce, tourisme, immobilier, services B2B — et qui veulent des automatisations fiables plutôt que des démonstrations.",
    ],
    servicesTitle: "Ce que je fais sur site à Bordeaux",
    services: [
      {
        title: "Audit IA",
        text: "Un ou deux jours d'immersion dans vos locaux : entretiens métiers, diagnostic des processus, priorisation ROI et feuille de route.",
        to: "/audit-ia",
        linkLabel: "Découvrir l'audit IA",
      },
      {
        title: "Automatisation commerciale",
        text: "Prospection, CRM, devis et relances : des workflows construits avec vos équipes, mesurés avant / après.",
        to: "/automatisation-commerciale",
        linkLabel: "Découvrir l'automatisation",
      },
      {
        title: "Formation IA",
        text: "Ateliers pratiques par métier dans vos bureaux : prompting utile, cas d'usage concrets, conduite du changement.",
        to: "/formation-ia",
        linkLabel: "Découvrir la formation",
      },
    ],
    localTitle: "Pourquoi Bordeaux",
    local: [
      "Bordeaux combine un tissu économique traditionnel puissant — vin et négoce international, tourisme, immobilier — et une scène tech dynamique. C'est exactement le profil d'entreprises où l'IA appliquée crée le plus de valeur : des processus établis, des équipes stables, des données sous-exploitées.",
      "Le format « expert externe en déplacement » y fonctionne très bien : des interventions sur site préparées et concentrées, une exécution à distance entre deux venues, et un coût de mission maîtrisé.",
    ],
    sectorsTitle: "Secteurs accompagnés en Nouvelle-Aquitaine",
    sectors: ["Vin & négoce", "Tourisme & hôtellerie", "Immobilier", "Services B2B", "SaaS & tech", "Retail"],
    termsTitle: "Modalités",
    terms: [
      { label: "Présence", value: "Déplacements à Bordeaux et en Nouvelle-Aquitaine, interventions de 1 à 2 jours sur site" },
      { label: "Formats", value: "Audit, ateliers en équipe, formation intra, accompagnement mensuel" },
      { label: "Langues", value: "Français, espagnol, anglais" },
      { label: "Premier rendez-vous", value: "Audit découverte gratuit de 30 minutes en visio" },
    ],
    ...
    faq: [
      {
        q: "Vous déplacez-vous à Bordeaux pour une mission ?",
        a: "Oui, j'interviens à Bordeaux en séquences sur site de un à deux jours — audit, ateliers, restitution — complétées par un suivi à distance. Ce format concentre l'impact et limite les coûts de mission.",
      },
      {
        q: "Quels types d'entreprises accompagnez-vous à Bordeaux ?",
        a: "Des PME et ETI du négoce, du tourisme, de l'immobilier et des services B2B : des activités aux processus établis où l'automatisation de la prospection, des devis et du suivi produit des gains rapides et mesurables.",
      },
      {
        q: "Comment démarre une collaboration ?",
        a: "Par un audit découverte gratuit de 30 minutes en visio. On identifie 2-3 cas d'usage prioritaires, puis je vous propose une feuille de route avec un périmètre, un calendrier et des indicateurs de succès.",
    ...
    ctaTitle: "Parlons de votre projet IA à Bordeaux",
    ctaText: "Réservez un créneau : audit découverte gratuit de 30 minutes.",
    ctaButton: "Réserver un créneau",
    ctaContactLabel: "Ou passez par la page contact",
    breadcrumbHome: "Accueil",
