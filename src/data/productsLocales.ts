...
export const productsAlternates = [
  { hrefLang: "fr", path: "/produits" },
  { hrefLang: "en", path: "/en/products" },
  { hrefLang: "es", path: "/es/productos" },
];

export const productsCanonicalByLocale: Record<PageLocale, string> = {
  fr: "/produits",
  en: "/en/products",
  es: "/es/productos",
};

export const productsLocales: Record<PageLocale, ProductsContent> = {
  fr: {
