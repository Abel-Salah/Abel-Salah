  ...
  return (
    <>
      <motion.button
        ...
        className="fixed bottom-6 right-6 z-40 inline-flex items-center gap-2 bg-gradient-to-r from-primary to-blue-400 text-primary-foreground px-5 py-3 font-semibold uppercase tracking-wider text-sm shadow-lg hover:opacity-90 transition-opacity"
      >
